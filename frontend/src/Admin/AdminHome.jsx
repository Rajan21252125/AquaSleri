          ...
          <table className="w-full table-auto border-collapse border border-gray-800">
            <thead>
              <tr>
                ...
                <th className="border border-gray-800 px-4 py-2">Discounted Price</th>
            ...
            <tbody>
              {products && products.map((product, index) => (
                <tr key={product?._id} className="border-b-2">
                  ...
                  <td className="px-4 py-2">{shortText(product.category.join(", "))}</td>
                  <td className="px-4 py-2">{shortText(product.description)}</td>
