...
import { IoSearch, IoCartOutline , IoMicOutline , IoBulbOutline } from "react-icons/io5";
        ...
        <div className="flex items-center justify-between h-full mx-6 sm:mx-10 lg:mx-20">
          <div className="md:flex justify-between">
            ...
            <ul className="hidden text-white text-[12px] lg:text-base xl:text-lg space-x-4 lg:space-x-8 ml-4 lg:ml-8 md:flex md:items-center">
                <Link to={"/purifiers"} ><li className="cursor-pointer flex items-center">
                  Water Purifier
                </li>
                </Link>
                <Link to={"/solutions"} >
              ...
              <Link to={"/new"} ><li className="cursor-pointer flex items-start relative">
                New Arrivals <p className="text-red-500 absolute -top-1 -right-2 text-base lg:text-xl">*</p>
              </li>
              </Link>
            </ul>
          </div>
          <div className="text-white text-lg md:text-xl lg:text-2xl flex space-x-2 md:space-x-6 items-center">
            ...
            <Link to={"/amc"} ><p className="hidden md:block text-[14px] lg:text-base bg-white text-black px-4 py-1 rounded-3xl font-bold hover:bg-blue-900 hover:text-white cursor-pointer transition duration-200">Buy AMC</p></Link>
          </div>
        </div>
      )}
      {/* Mobile View */}
        <div className="md:hidden flex py-3 px-4 fixed bottom-0  text-black text-lg bg-gray-800 shadow-xl w-full">
          <ul className="flex space-x-4 items-center justify-evenly w-full">
            <Link to={"/purifiers"} ><li className="cursor-pointer relative flex flex-col items-center text-[10px] sm:text-sm font-semibold text-white hover:underline">
            <PiSquaresFour className="text-sm sm:text-base"/> Purifier
            </li>
            </Link>
            <Link to={"/solutions"} ><li className="cursor-pointer relative flex flex-col items-center text-[10px] sm:text-sm font-semibold text-white hover:underline">
            <IoBulbOutline className="text-sm sm:text-base"/> Solutions
            </li>
            </Link>
            <Link to={"/service"} ><li className="cursor-pointer relative flex flex-col items-center text-[10px] sm:text-sm font-semibold text-white hover:underline">
              <HiOutlineWrenchScrewdriver className="text-sm sm:text-base"/> Service
            </li>
            </Link>
            <Link to={"/new"} ><li className="cursor-pointer relative flex flex-col items-center text-[10px] sm:text-sm font-semibold text-white hover:underline">
              <BsRocket className="text-sm sm:text-base"/> New Arrivals
            </li>
            </Link>
            <Link to={"/amc"} ><li className="cursor-pointer relative flex flex-col items-center text-[10px] sm:text-sm font-semibold text-white hover:underline">
